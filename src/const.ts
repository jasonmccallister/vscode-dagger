...
export const INSTALL_COMMAND_CURL =
...
export const FEEDBACK_URL =
  "https://github.com/jasonmccallister/vscode-dagger/issues/new?template=bug_report.md";
export const FEATURE_REQUEST_URL =
  "https://github.com/jasonmccallister/vscode-dagger/issues/new?template=feature_request.md";
export const DISCUSSIONS_URL =
  "https://github.com/jasonmccallister/vscode-dagger/discussions";

// Miscellaneous
export const CHAT_PARTICIPANT_ID = "dagger";
export const CHAT_PARTICIPANT_NAME = "@dagger";
export const CHAT_PARTICIPANT_DESCRIPTION =
  "Searches docs.dagger.io for information on developing Dagger modules.";
