...
describe('DaggerSettings', () => {
    ...
    beforeEach(() => {
        ...
        mockConfiguration.get.withArgs('cloudNotificationDismissed', false).returns(false);
        mockConfiguration.get.withArgs('saveTaskPromptDismissed', false).returns(false);
        mockConfiguration.get.withArgs('functionCalls.runInBackground', false).returns(false);
    ...
    describe('cloudNotificationDismissed setting', () => {
        ...
        it('should load cloudNotificationDismissed setting from configuration', () => {
            mockConfiguration.get.withArgs('cloudNotificationDismissed', false).returns(true);
    ...
    describe('saveTaskPromptDismissed setting', () => {
        ...
        it('should load saveTaskPromptDismissed setting from configuration', () => {
            mockConfiguration.get.withArgs('saveTaskPromptDismissed', false).returns(true);
    ...
    describe('runFunctionCallsInBackground setting', () => {
        ...
        it('should load runFunctionCallsInBackground setting from configuration', () => {
            mockConfiguration.get.withArgs('functionCalls.runInBackground', false).returns(true);
    ...
    describe('update method', () => {
        ...
        it('should reload settings after update', async () => {
            ...
            // Update a setting
            await settings.update('enableCache', false, vscode.ConfigurationTarget.Global);
